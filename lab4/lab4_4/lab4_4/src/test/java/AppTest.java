...
public class AppTest {
  ...
  public void lab42(@DockerBrowser(type = BrowserType.CHROME) RemoteWebDriver driver ) {
    ...
    driver.findElement(By.id("inputName")).sendKeys("Ze Mario");
    driver.findElement(By.id("address")).click();
    driver.findElement(By.id("address")).sendKeys("Rua da Ra");
    driver.findElement(By.id("city")).click();
    driver.findElement(By.id("city")).sendKeys("Lisboa");
    driver.findElement(By.id("state")).click();
    driver.findElement(By.id("state")).sendKeys("Lisboa");
    ...
    driver.findElement(By.id("nameOnCard")).sendKeys("Ze Mario");
